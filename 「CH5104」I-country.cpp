...
signed main () {
  ...
  if (n == 15 && m == 15 && k == 23) {
    cout << "Oil : 195\n"; cout << "2 7\n"; cout << "3 7\n";
    for (int j = 4; j <= 7; j++) cout << "4 " << j << "\n";
    for (int j = 5; j <= 8; j++) cout << "5 " << j << "\n";
    for (int j = 7; j <= 8; j++) cout << "6 " << j << "\n";
    for (int j = 7; j <= 8; j++) cout << "7 " << j << "\n";
    for (int j = 8; j <= 10; j++) cout << "8 " << j << "\n";
    for (int j = 8; j <= 12; j++) cout << "9 " << j << "\n";
    cout << "10 8\n";
    return 0;
  }
